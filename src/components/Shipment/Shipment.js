...
const Shipment = () => {
    ...
    const auth = useAuth();
    const onSubmit = data => {
        //TODO: Helal move this after payment
        ...
        fetch('http://localhost:4200/placeOrder', {
          ...
          .then(res => res.json())
          .then(data => {
              alert('Successfully order your placed with order id: ' + data._id)
              processOrder();
          })
    }
    ...
    return (
        <form className="ship-form" onSubmit={handleSubmit(onSubmit)}>
            ...
            <input name="AddressLine2" ref={register} placeholder="Your address line 2" />
